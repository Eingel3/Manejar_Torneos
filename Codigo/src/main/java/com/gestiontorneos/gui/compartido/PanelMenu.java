...
public class PanelMenu extends JPanel {
    public  PanelMenu() {
        ...
        JButton prueba = new JButton("Prueba"); //creamos un boton de prueba
        this.add(prueba); //y lo probamos
    }
    ...
    boton.setPreferredSize(new Dimension(100, 80)); //Le dejamos como un rectangulo un poquito mas chico que el ancho del menu
