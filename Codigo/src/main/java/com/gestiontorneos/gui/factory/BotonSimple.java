...
public class BotonSimple implements BotonFactory {
    ...
    public JButton crear(String nombre) {
        ...
        boton.setPreferredSize(new Dimension(com.gestiontorneos.gui.compartido.PanelInformacion.MENULATERAL.getAncho() - 10, 30)); //Le dejamos como un rectangulo un poquito mas chico que el ancho del menu
